...
Every computer likely has some basic text editor installed. Notepad/Muistio (Windows), TextEdit (Mac), Text Editor, gedit (Linux) or something along those lines. 
